...
get_filename_component(_filename "/home/pi/ros_ws/src/test_service/srv/example_service.srv" NAME_WE)
add_custom_target(_test_service_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "test_service" "/home/pi/ros_ws/src/test_service/srv/example_service.srv" ""
)
...
_generate_srv_cpp(test_service
  "/home/pi/ros_ws/src/test_service/srv/example_service.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/test_service)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/test_service\")")
  # install generated code
  install(
